...
--CREATE SEQUENCES
CREATE SEQUENCE SEQ_LANGUAGES MINVALUE 1 MAXVALUE /*99*/999999999999999 START WITH 1 INCREMENT BY 1 NOCACHE;
CREATE SEQUENCE SEQ_PART_OF_SPEECHES MINVALUE 1 MAXVALUE /*50*/999999999999999 START WITH 1 INCREMENT BY 1 NOCACHE;
...
CREATE OR REPLACE VIEW V_TRANSLATES AS
  ...
  /*SELECT T.*, 
		FIRST_WORD.*, 
		SECOND_WORD.*
	FROM T_TRANSLATES T INNER JOIN 
		(SELECT * FROM V_WORDS_PART_OF_SPEECHES VWPOS) FIRST_WORD ON FIRST_WORD.PART_OF_SPEECH_WORD_ID = T.PART_OF_SPEECH_WORD_ID_F
		INNER JOIN (SELECT * FROM V_WORDS_PART_OF_SPEECHES VWPOS) SECOND_WORD ON SECOND_WORD.PART_OF_SPEECH_WORD_ID = T.PART_OF_SPEECH_WORD_ID_S;*/
  /**
  PART_OF_SPEECH_WORD_ID_F
	PART_OF_SPEECH_WORD_ID_S
  */
