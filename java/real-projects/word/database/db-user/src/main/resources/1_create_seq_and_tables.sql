...
CREATE TABLE T_ROLES(
  ROLE_ID NUMBER(10,0) DEFAULT SEQ_ROLE.NEXTVAL NOT NULL,
...
CREATE TABLE T_PASSWORD_HISTORY(
  ACCOUNT_USER_ID NUMBER(10,0) NOT NULL,
  ACCOUNT_PASSWORD VARCHAR2(256 BYTE) NOT NULL,
  CONSTRAINT PH_ACCOUNT_USER_ID_FK FOREIGN KEY (ACCOUNT_USER_ID) REFERENCES T_ACCOUNTS(ACCOUNT_USER_ID)
);
