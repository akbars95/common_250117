...
BEGIN
  ...
  --insert accounts
  ACCOUNT_ADMIN := PKG_ACCOUNTS.GET_ACCOUNT(USER_ADMIN.USER_ID, 'ivanov.ivan', 'ivanov.ivan');
  PKG_ACCOUNTS.INSERT_ACCOUNT(ACCOUNT_ADMIN);
  ACCOUNT_SIMPLE_USER := PKG_ACCOUNTS.GET_ACCOUNT(USER_SIMPLE_USER.USER_ID, 'durov.daniil', 'durov.daniil');
