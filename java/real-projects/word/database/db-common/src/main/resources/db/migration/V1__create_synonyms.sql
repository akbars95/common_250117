...
CREATE OR REPLACE SYNONYM T_GROUPS FOR ${db.user.user_user_db}.T_GROUPS;
CREATE OR REPLACE SYNONYM T_GROUP_ROLES FOR ${db.user.user_user_db}.T_GROUP_ROLES;
CREATE OR REPLACE SYNONYM T_GROUP_USERS FOR ${db.user.user_user_db}.T_GROUP_USERS;
